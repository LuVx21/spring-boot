...
TimeGeneration.prototype = {
    ...
    getTime: function () {
        var time = new Date();
        return [parseInt(time.getHours() / 10), parseInt(time.getHours() % 10), parseInt(time.getMinutes() / 10), parseInt(time.getMinutes() % 10), parseInt(time.getSeconds() / 10), parseInt(time.getSeconds() % 10)]
    },
    getDate: function () {
        var date = new Date();
        return [date.getMonth() + 1, date.getDate(), this.WEEKDAY_NAME[date.getDay()]]
    },
