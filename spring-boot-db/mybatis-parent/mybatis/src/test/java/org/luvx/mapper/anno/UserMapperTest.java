...
public class UserMapperTest extends ApplicationTests {
    ...
    public void insertSelectiveTest() {
        User user = User.builder().userName("foo").password("bar").build();
        log.info("插入前: {}", user);
    ...
    public void insertListTest() {
        ...
        User user2 = User.builder().userName("foo").password("bar").age(18).build();
    ...
    public void updateByPrimaryKeyTest() {
        User user = User.builder().id(10043L).userName("foo").password("bar").age(19).build();
    ...
    public void updateByPrimaryKeySelectiveTest() {
        User user = User.builder().id(10044L).userName("foo").password("bar").build();
    ...
    public void updateSelectiveTest() {
        User user = User.builder().userName("foo").password("bar").age(18).build();
        User user1 = User.builder().userName("foo_").password("bar_").age(20).build();
        userMapper.updateSelective(user, user1);
    }

    @Test
    public void updateByPrimaryKeyListTest() {
        User user = User.builder().userName("foo").password("bar").age(20).build();
    ...
    public void updateSelectiveListTest() {
        User user1 = User.builder().userName("foo").password("bar").age(20).build();
        User user2 = User.builder().userName("foo").password("bar").age(21).build();

        User user3 = User.builder().userName("foo_").password("bar_").age(18).build();
    ...
    public void selectSelectiveListTest() {
        User user1 = User.builder().userName("foo").password("bar").age(18).build();
        User user2 = User.builder().userName("foo_")
                // .password("bar")
                .age(20).build();
